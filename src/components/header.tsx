...
const Header = () => {
  return (
    <div className="font-raleway backdrop-blur-md bg-black/50 md:bg-white shadow-md p-4 md:px-14 fixed top-0 left-0 right-0 z-50 mx-auto">
      <div className="flex items-center w-full justify-between">
        ...
        <div className="flex md:block items-center gap-3">
          <Button className="relative group overflow-hidden shadow-none rounded-full text-sm md:border border-[#377389] hover:bg-white hover:text-white bg-white text-[#377389]">
